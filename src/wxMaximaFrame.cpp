...
#define APPEND_MENU_ITEM(menu, id, label, help, stock)  \
  ...
  charTestMenu->Append(menu_stringproc_cequalignore, _("Equal, ignoring case?..."));
  charTestMenu->Append(menu_stringproc_clessp, _("Is lower?..."));
  charTestMenu->Append(menu_stringproc_clesspignore, _("Lower, ignoring case?..."));
  charTestMenu->Append(menu_stringproc_cgreaterp, _("Is greater?..."));
  charTestMenu->Append(menu_stringproc_cgreaterpignore, _("Greater, ignoring case?..."));
  ...
  stringtestMenu->Append(menu_stringproc_sequalignore, _("Equal, ignoring case?..."));
  ...
  convertMenu->Append(menu_stringproc_unicode, _("Unicode code point to char..."));
  convertMenu->Append(menu_stringproc_unicode_to_utf8, _("Unicode code point to UTF8..."));
  convertMenu->Append(menu_stringproc_utf8_to_unicode, _("UTF8 to Unicode code point..."));
  convertMenu->Append(menu_stringproc_charlist, _("String to list of chars..."));
  convertMenu->Append(menu_stringproc_simplode, _("List of chars to string..."));
  ...
  convertMenu->Append(menu_stringproc_number_to_octets, _("Number to octets..."));
  convertMenu->Append(menu_stringproc_octets_to_number, _("Octets to number..."));
  convertMenu->Append(menu_stringproc_octets_to_string, _("Octets to string..."));
  convertMenu->Append(menu_stringproc_string_to_octets, _("String to octets..."));
  ...
  transformMenu->Append(menu_stringproc_smismatch, _("Find first difference..."));
  transformMenu->Append(menu_stringproc_split, _("Split..."));
  transformMenu->Append(menu_stringproc_sposition, _("Find char in string..."));
  transformMenu->Append(menu_stringproc_sremove, _("Remove all occurrences of a word..."));
  transformMenu->Append(menu_stringproc_sremovefirst, _("Remove first occurrence of a word..."));
  ...
  lapack_menu->Append(menu_matrix_loadLapack, _("Load lapack"),
                      _("Load lapack"),
                      wxITEM_NORMAL);
  lapack_menu->Append(menu_matrix_dgeev_eigenvaluesOnly, _("Eigenvalues (real)"),
                      _("Compile eigenvalues using dgeev"),
                      wxITEM_NORMAL);
  lapack_menu->Append(menu_matrix_zgeev_eigenvaluesOnly, _("Eigenvalues (complex)"),
                      _("Compile eigenvalues using zgeev"),
                      wxITEM_NORMAL);
...
m_CalculusMenu->AppendSeparator();
  ...
  floatToExactSub->Append(menu_rationalize, _("To exact fraction"),
                        _("Find a fraction that represents this float exactly"),
                        wxITEM_NORMAL);
