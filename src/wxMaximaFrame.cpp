...
wxMaximaFrame::wxMaximaFrame(wxWindow *parent, int id, wxLocale *locale,
  ...
  : wxFrame(parent, id, title, pos, size, style),
    menu_pane_hideall(wxNewId()),
    menu_pane_math(wxNewId()),
    menu_pane_history(wxNewId()),
    menu_pane_structure(wxNewId()),
    menu_pane_xmlInspector(wxNewId()),
    menu_pane_format(wxNewId()),
    menu_pane_greek(wxNewId()),
    menu_pane_unicode(wxNewId()),
    menu_pane_log(wxNewId()),
    menu_pane_variables(wxNewId()),
    menu_pane_draw(wxNewId()),
    menu_pane_help(wxNewId()),
    menu_pane_symbols(wxNewId()),
    menu_pane_stats(wxNewId()),
    menu_pane_dockAll(wxNewId()),
    input_line_id(wxNewId()),
    refresh_id(wxNewId()),
    menu_batch_id(wxNewId()),
    menu_load_id(wxNewId()),
    menu_sconsole_id(wxNewId()),
    menu_interrupt_id(wxNewId()),
    menu_solve(wxNewId()),
    menu_solve_to_poly(wxNewId()),
    menu_solve_num(wxNewId()),
    menu_allroots(wxNewId()),
    menu_bfallroots(wxNewId()),
    menu_realroots(wxNewId()),
    menu_solve_lin(wxNewId()),
    menu_solve_algsys(wxNewId()),
    menu_eliminate(wxNewId()),
    menu_solve_ode(wxNewId()),
    menu_ivp_1(wxNewId()),
    menu_ivp_2(wxNewId()),
    menu_rk(wxNewId()),
    menu_bvp(wxNewId()),
    menu_genmatrix(wxNewId()),
    menu_gen_mat(wxNewId()),
    menu_gen_mat_lambda(wxNewId()),
    menu_enter_mat(wxNewId()),
    menu_csv2mat(wxNewId()),
    menu_mat2csv(wxNewId()),
    menu_csv2list(wxNewId()),
    menu_list2csv(wxNewId()),
    menu_matrix_row(wxNewId()),
    menu_matrix_col(wxNewId()),
    menu_matrix_row_list(wxNewId()),
    menu_matrix_col_list(wxNewId()),
    menu_submatrix(wxNewId()),
    menu_matrix_multiply(wxNewId()),
    menu_matrix_exponent(wxNewId()),
    menu_matrix_hadamard_product(wxNewId()),
    menu_matrix_hadamard_exponent(wxNewId()),
    menu_matrix_loadLapack(wxNewId()),
    menu_matrix_dgeev_eigenvaluesOnly(wxNewId()),
    menu_matrix_dgeev(wxNewId()),
    menu_matrix_zgeev_eigenvaluesOnly(wxNewId()),
    menu_matrix_zgeev(wxNewId()),
    menu_matrix_dgeqrf(wxNewId()),
    menu_matrix_dgesv(wxNewId()),
    menu_matrix_dgesvd(wxNewId()),
    menu_matrix_dgesvd_valuesOnly(wxNewId()),
    menu_matrix_dlange_max(wxNewId()),
    menu_matrix_dlange_one(wxNewId()),
    menu_matrix_dlange_inf(wxNewId()),
    menu_matrix_dlange_frobenius(wxNewId()),
    menu_matrix_zlange_max(wxNewId()),
    menu_matrix_zlange_one(wxNewId()),
    menu_matrix_zlange_inf(wxNewId()),
    menu_matrix_zlange_frobenius(wxNewId()),
    menu_matrix_zheev(wxNewId()),
    menu_invert_mat(wxNewId()),
    menu_cpoly(wxNewId()),
    menu_determinant(wxNewId()),
    menu_rank(wxNewId()),
    menu_eigen(wxNewId()),
    menu_eigvect(wxNewId()),
    menu_fun_def(wxNewId()),
    menu_gensym(wxNewId()),
    menu_adjoint_mat(wxNewId()),
    menu_transpose(wxNewId()),
    menu_map_mat(wxNewId()),
    menu_map(wxNewId()),
    menu_map_lambda(wxNewId()),
    menu_copymatrix(wxNewId()),
    menu_ratsimp(wxNewId()),
    menu_radsimp(wxNewId()),
    menu_scanmapfactor(wxNewId()),
    menu_factor(wxNewId()),
    menu_horner(wxNewId()),
    menu_collapse(wxNewId()),
    menu_optimize(wxNewId()),
    menu_mainvar(wxNewId()),
    menu_grind(wxNewId()),
    menu_gfactor(wxNewId()),
    menu_expand(wxNewId()),
    menu_expandwrt(wxNewId()),
    menu_expandwrt_denom(wxNewId()),
    menu_stringproc_setposition(wxNewId()),
    menu_stringproc_getposition(wxNewId()),
    menu_stringproc_flush_output(wxNewId()),
    menu_stringproc_flength(wxNewId()),
    menu_stringproc_close(wxNewId()),
    menu_stringproc_opena(wxNewId()),
    menu_stringproc_openr(wxNewId()),
    menu_stringproc_openw(wxNewId()),
    menu_stringproc_printf(wxNewId()),
    menu_stringproc_readline(wxNewId()),
    menu_stringproc_readchar(wxNewId()),
    menu_stringproc_readbyte(wxNewId()),
    menu_stringproc_writebyte(wxNewId()),
    menu_stringproc_charp(wxNewId()),
    menu_stringproc_alphacharp(wxNewId()),
    menu_stringproc_alphanumericp(wxNewId()),
    menu_stringproc_digitcharp(wxNewId()),
    menu_stringproc_constituent(wxNewId()),
    menu_stringproc_uppercasep(wxNewId()),
    menu_stringproc_lowercasep(wxNewId()),
    menu_stringproc_create_ascii(wxNewId()),
    menu_stringproc_cequal(wxNewId()),
    menu_stringproc_cequalignore(wxNewId()),
    menu_stringproc_clessp(wxNewId()),
    menu_stringproc_clesspignore(wxNewId()),
    menu_stringproc_cgreaterp(wxNewId()),
    menu_stringproc_cgreaterpignore(wxNewId()),
    menu_stringproc_sequal(wxNewId()),
    menu_stringproc_sequalignore(wxNewId()),
    menu_stringproc_ascii(wxNewId()),
    menu_stringproc_cint(wxNewId()),
    menu_stringproc_unicode(wxNewId()),
    menu_stringproc_unicode_to_utf8(wxNewId()),
    menu_stringproc_utf8_to_unicode(wxNewId()),
    menu_stringproc_charat(wxNewId()),
    menu_stringproc_charlist(wxNewId()),
    menu_stringproc_simplode(wxNewId()),
    menu_stringproc_sinsert(wxNewId()),
    menu_stringproc_eval_string(wxNewId()),
    menu_stringproc_parse_string(wxNewId()),
    menu_stringproc_scopy(wxNewId()),
    menu_stringproc_sdowncase(wxNewId()),
    menu_stringproc_slength(wxNewId()),
    menu_stringproc_smake(wxNewId()),
    menu_stringproc_smismatch(wxNewId()),
    menu_stringproc_split(wxNewId()),
    menu_stringproc_sposition(wxNewId()),
    menu_stringproc_sremove(wxNewId()),
    menu_stringproc_sremovefirst(wxNewId()),
    menu_stringproc_tokens(wxNewId()),
    menu_stringproc_ssearch(wxNewId()),
    menu_stringproc_ssort(wxNewId()),
    menu_stringproc_ssubstfirst(wxNewId()),
    menu_stringproc_strim(wxNewId()),
    menu_stringproc_striml(wxNewId()),
    menu_stringproc_strimr(wxNewId()),
    menu_stringproc_number_to_octets(wxNewId()),
    menu_stringproc_octets_to_number(wxNewId()),
    menu_stringproc_octets_to_string(wxNewId()),
    menu_stringproc_string_to_octets(wxNewId()),
    menu_sregex_load(wxNewId()),
    menu_sregex_regex_compile(wxNewId()),
    menu_sregex_regex_match_pos(wxNewId()),
    menu_sregex_regex_match(wxNewId()),
    menu_sregex_regex_split(wxNewId()),
    menu_sregex_subst_first(wxNewId()),
    menu_sregex_regex_subst(wxNewId()),
    menu_sregex_string_to_regex(wxNewId()),
    menu_opsyst_load(wxNewId()),
    menu_opsyst_chdir(wxNewId()),
    menu_opsyst_mkdir(wxNewId()),
    menu_opsyst_rmdir(wxNewId()),
    menu_opsyst_getcurrentdirectory(wxNewId()),
    menu_opsyst_copy_file(wxNewId()),
    menu_opsyst_rename_file(wxNewId()),
    menu_opsyst_delete_file(wxNewId()),
    menu_opsyst_getenv(wxNewId()),
    menu_opsyst_directory(wxNewId()),
    menu_opsyst_pathname_directory(wxNewId()),
    menu_opsyst_pathname_name(wxNewId()),
    menu_opsyst_pathname_type(wxNewId()),
    menu_scsimp(wxNewId()),
    menu_xthru(wxNewId()),
    menu_talg(wxNewId()),
    menu_tellrat(wxNewId()),
    menu_modulus(wxNewId()),
    menu_trigsimp(wxNewId()),
    menu_trigreduce(wxNewId()),
    menu_trigexpand(wxNewId()),
    menu_trigrat(wxNewId()),
    menu_rectform(wxNewId()),
    menu_polarform(wxNewId()),
    menu_demoivre(wxNewId()),
    menu_exponentialize(wxNewId()),
    menu_num_out(wxNewId()),
    menu_stringdisp(wxNewId()),
    menu_to_float(wxNewId()),
    menu_to_bfloat(wxNewId()),
    menu_to_numer(wxNewId()),
    menu_rat(wxNewId()),
    menu_rationalize(wxNewId()),
    menu_guess_exact_value(wxNewId()),
    menu_quad_qag(wxNewId()),
    menu_quad_qags(wxNewId()),
    menu_quad_qagi(wxNewId()),
    menu_quad_qawc(wxNewId()),
    menu_quad_qawf_sin(wxNewId()),
    menu_quad_qawf_cos(wxNewId()),
    menu_quad_qawo_sin(wxNewId()),
    menu_quad_qawo_cos(wxNewId()),
    menu_quad_qaws1(wxNewId()),
    menu_quad_qaws2(wxNewId()),
    menu_quad_qaws3(wxNewId()),
    menu_quad_qaws4(wxNewId()),
    menu_quad_qagp(wxNewId()),
    menu_num_domain(wxNewId()),
    menu_set_precision(wxNewId()),
    menu_set_displayprecision(wxNewId()),
    menu_engineeringFormat(wxNewId()),
    menu_engineeringFormatSetup(wxNewId()),
    menu_functions(wxNewId()),
    menu_variables(wxNewId()),
    menu_arrays(wxNewId()),
    menu_macros(wxNewId()),
    menu_labels(wxNewId()),
    menu_myoptions(wxNewId()),
    menu_rules(wxNewId()),
    menu_aliases(wxNewId()),
    menu_structs(wxNewId()),
    menu_dependencies(wxNewId()),
    menu_gradefs(wxNewId()),
    menu_let_rule_packages(wxNewId()),
    menu_maxima_uses_internal_help(wxNewId()),
    menu_maxima_uses_html_help(wxNewId()),
    menu_maxima_uses_wxmaxima_help(wxNewId()),
    menu_goto_url(wxNewId()),
    menu_clear_var(wxNewId()),
    menu_clear_fun(wxNewId()),
    menu_kill(wxNewId()),
    menu_integrate(wxNewId()),
    menu_risch(wxNewId()),
    menu_laplace(wxNewId()),
    menu_ilt(wxNewId()),
    menu_continued_fraction(wxNewId()),
    menu_gcd(wxNewId()),
    menu_lcm(wxNewId()),
    menu_divide(wxNewId()),
    menu_partfrac(wxNewId()),
    menu_sum(wxNewId()),
    menu_simpsum(wxNewId()),
    menu_limit(wxNewId()),
    menu_lbfgs(wxNewId()),
    menu_taylor(wxNewId()),
    menu_powerseries(wxNewId()),
    menu_fourier(wxNewId()),
    menu_pade(wxNewId()),
    menu_diff(wxNewId()),
    menu_solve_de(wxNewId()),
    menu_atvalue(wxNewId()),
    menu_lhs(wxNewId()),
    menu_rhs(wxNewId()),
    menu_wxmaximahelp(wxNewId()),
    menu_maximahelp(wxNewId()),
    menu_example(wxNewId()),
    menu_apropos(wxNewId()),
    menu_product(wxNewId()),
    menu_time(wxNewId()),
    menu_factsimp(wxNewId()),
    menu_factcomb(wxNewId()),
    menu_realpart(wxNewId()),
    menu_imagpart(wxNewId()),
    menu_subst(wxNewId()),
    menu_psubst(wxNewId()),
    menu_ratsubst(wxNewId()),
    menu_fullratsubst(wxNewId()),
    menu_at(wxNewId()),
    menu_substinpart(wxNewId()),
    menu_opsubst(wxNewId()),
    menu_jumptoerror(wxNewId()),
    menu_math_as_1D_ASCII(wxNewId()),
    menu_math_as_2D_ASCII(wxNewId()),
    menu_math_as_graphics(wxNewId()),
    menu_logexpand_false(wxNewId()),
    menu_logexpand_true(wxNewId()),
    menu_logexpand_all(wxNewId()),
    menu_logexpand_super(wxNewId()),
    menu_noAutosubscript(wxNewId()),
    menu_defaultAutosubscript(wxNewId()),
    menu_alwaysAutosubscript(wxNewId()),
    menu_autosubscriptIndividual(wxNewId()),
    menu_declareAutosubscript(wxNewId()),
    menu_noAutosubscriptIndividual(wxNewId()),
    menu_roundedMatrixParens(wxNewId()),
    menu_squareMatrixParens(wxNewId()),
    menu_straightMatrixParens(wxNewId()),
    menu_angledMatrixParens(wxNewId()),
    menu_noMatrixParens(wxNewId()),
    menu_draw_2d(wxNewId()),
    menu_draw_3d(wxNewId()),
    menu_draw_explicit(wxNewId()),
    menu_draw_implicit(wxNewId()),
    menu_draw_parametric(wxNewId()),
    menu_draw_points(wxNewId()),
    menu_draw_fgcolor(wxNewId()),
    menu_draw_fillcolor(wxNewId()),
    menu_draw_title(wxNewId()),
    menu_draw_key(wxNewId()),
    menu_draw_grid(wxNewId()),
    menu_draw_axis(wxNewId()),
    menu_draw_accuracy(wxNewId()),
    menu_draw_contour(wxNewId()),
    menu_license(wxNewId()),
    menu_changelog(wxNewId()),
    button_factor_id(wxNewId()),
    button_solve(wxNewId()),
    button_solve_ode(wxNewId()),
    button_limit(wxNewId()),
    button_taylor(wxNewId()),
    button_expand(wxNewId()),
    button_ratsimp(wxNewId()),
    button_radcan(wxNewId()),
    button_trigsimp(wxNewId()),
    button_trigexpand(wxNewId()),
    button_trigreduce(wxNewId()),
    button_trigrat(wxNewId()),
    button_integrate(wxNewId()),
    button_diff(wxNewId()),
    button_sum(wxNewId()),
    button_product(wxNewId()),
    button_button_constant(wxNewId()),
    button_factor(wxNewId()),
    button_subst(wxNewId()),
    button_plot2(wxNewId()),
    button_plot3(wxNewId()),
    button_rectform(wxNewId()),
    button_map(wxNewId()),
    gp_plot2(wxNewId()),
    gp_plot3(wxNewId()),
    menu_animationautostart(wxNewId()),
    menu_animationframerate(wxNewId()),
    menu_display(wxNewId()),
    menu_soft_restart(wxNewId()),
    menu_plot_format(wxNewId()),
    menu_build_info(wxNewId()),
    menu_bug_report(wxNewId()),
    menu_add_path(wxNewId()),
    menu_evaluate_all_visible(wxNewId()),
    menu_evaluate_all(wxNewId()),
    menu_show_tip(wxNewId()),
    menu_copy_matlab_from_worksheet(wxNewId()),
    menu_copy_tex_from_worksheet(wxNewId()),
    menu_copy_text_from_worksheet(wxNewId()),
    menu_logcontract(wxNewId()),
    menu_logexpand(wxNewId()),
    menu_to_fact(wxNewId()),
    menu_to_gamma(wxNewId()),
    menu_texform(wxNewId()),
    menu_debugmode(wxNewId()),
    menu_debugmode_off(wxNewId()),
    menu_debugmode_lisp(wxNewId()),
    menu_debugmode_all(wxNewId()),
    menu_for(wxNewId()),
    menu_while(wxNewId()),
    menu_block(wxNewId()),
    menu_block_noLocal(wxNewId()),
    menu_local(wxNewId()),
    menu_return(wxNewId()),
    menu_trace(wxNewId()),
    menu_lambda(wxNewId()),
    menu_quotequote(wxNewId()),
    menu_quote(wxNewId()),
    menu_quoteblock(wxNewId()),
    menu_def_fun(wxNewId()),
    menu_def_macro(wxNewId()),
    menu_def_variable(wxNewId()),
    menu_compile(wxNewId()),
    menu_paramType(wxNewId()),
    menu_structdef(wxNewId()),
    menu_structnew(wxNewId()),
    menu_structuse(wxNewId()),
    menu_saveLisp(wxNewId()),
    menu_loadLisp(wxNewId()),
    menu_maximatostring(wxNewId()),
    menu_stringtomaxima(wxNewId()),
    button_enter(wxNewId()),
    menu_zoom_80(wxNewId()),
    menu_zoom_120(wxNewId()),
    menu_zoom_150(wxNewId()),
    menu_zoom_200(wxNewId()),
    menu_zoom_300(wxNewId()),
    menu_copy_as_bitmap(wxNewId()),
    menu_copy_as_svg(wxNewId()),
    menu_save_as_svg(wxNewId()),
    menu_copy_as_emf(wxNewId()),
    menu_save_as_emf(wxNewId()),
    menu_copy_as_rtf(wxNewId()),
    menu_copy_to_file(wxNewId()),
    menu_export_html(wxNewId()),
    menu_change_var(wxNewId()),
    menu_change_var_evaluate(wxNewId()),
    menu_nouns(wxNewId()),
    menu_evaluate(wxNewId()),
    menu_convert_to_code(wxNewId()),
    menu_add_comment(wxNewId()),
    menu_convert_to_comment(wxNewId()),
    menu_add_subsubsection(wxNewId()),
    menu_add_heading5(wxNewId()),
    menu_add_heading6(wxNewId()),
    menu_convert_to_subsubsection(wxNewId()),
    menu_convert_to_heading5(wxNewId()),
    menu_convert_to_heading6(wxNewId()),
    menu_add_subsection(wxNewId()),
    menu_convert_to_subsection(wxNewId()),
    menu_add_section(wxNewId()),
    menu_convert_to_section(wxNewId()),
    menu_add_title(wxNewId()),
    menu_convert_to_title(wxNewId()),
    menu_add_pagebreak(wxNewId()),
    menu_fold_all_cells(wxNewId()),
    menu_unfold_all_cells(wxNewId()),
    menu_insert_input(wxNewId()),
    menu_insert_previous_input(wxNewId()),
    menu_insert_previous_output(wxNewId()),
    menu_autocomplete(wxNewId()),
    menu_autocomplete_templates(wxNewId()),
    menu_paste_input(wxNewId()),
    menu_fullscreen(wxNewId()),
    menu_remove_output(wxNewId()),
    menu_list_create_from_elements(wxNewId()),
    menu_list_create_from_rule(wxNewId()),
    menu_list_create_from_list(wxNewId()),
    menu_list_create_from_args(wxNewId()),
    menu_list_list2matrix(wxNewId()),
    menu_list_matrix2list(wxNewId()),
    menu_list_actual_values_storage(wxNewId()),
    menu_list_sort(wxNewId()),
    menu_list_remove_duplicates(wxNewId()),
    menu_list_length(wxNewId()),
    menu_list_push(wxNewId()),
    menu_list_pop(wxNewId()),
    menu_list_reverse(wxNewId()),
    menu_list_first(wxNewId()),
    menu_list_last(wxNewId()),
    menu_list_lastn(wxNewId()),
    menu_list_rest(wxNewId()),
    menu_list_restN(wxNewId()),
    menu_list_nth(wxNewId()),
    menu_list_map(wxNewId()),
    menu_list_use_actual_values(wxNewId()),
    menu_list_extract_value(wxNewId()),
    menu_list_as_function_arguments(wxNewId()),
    menu_list_do_for_each_element(wxNewId()),
    menu_list_remove_element(wxNewId()),
    menu_list_append_item_start(wxNewId()),
    menu_list_append_item_end(wxNewId()),
    menu_list_append_list(wxNewId()),
    menu_list_interleave(wxNewId()),
    menu_recent_packages(wxNewId()),
    menu_recent_package_0(wxNewId()),
    menu_recent_package_1(wxNewId()),
    menu_recent_package_2(wxNewId()),
    menu_recent_package_3(wxNewId()),
    menu_recent_package_4(wxNewId()),
    menu_recent_package_5(wxNewId()),
    menu_recent_package_6(wxNewId()),
    menu_recent_package_7(wxNewId()),
    menu_recent_package_8(wxNewId()),
    menu_recent_package_9(wxNewId()),
    menu_recent_package_10(wxNewId()),
    menu_recent_package_11(wxNewId()),
    menu_recent_package_12(wxNewId()),
    menu_recent_package_13(wxNewId()),
    menu_recent_package_14(wxNewId()),
    menu_recent_package_15(wxNewId()),
    menu_recent_package_16(wxNewId()),
    menu_recent_package_17(wxNewId()),
    menu_recent_package_18(wxNewId()),
    menu_recent_package_19(wxNewId()),
    menu_recent_package_20(wxNewId()),
    menu_recent_package_21(wxNewId()),
    menu_recent_package_22(wxNewId()),
    menu_recent_package_23(wxNewId()),
    menu_recent_package_24(wxNewId()),
    menu_recent_package_25(wxNewId()),
    menu_recent_package_26(wxNewId()),
    menu_recent_package_27(wxNewId()),
    menu_recent_package_28(wxNewId()),
    menu_recent_package_29(wxNewId()),
    menu_recent_documents(wxNewId()),
    menu_recent_document_0(wxNewId()),
    menu_recent_document_1(wxNewId()),
    menu_recent_document_2(wxNewId()),
    menu_recent_document_3(wxNewId()),
    menu_recent_document_4(wxNewId()),
    menu_recent_document_5(wxNewId()),
    menu_recent_document_6(wxNewId()),
    menu_recent_document_7(wxNewId()),
    menu_recent_document_8(wxNewId()),
    menu_recent_document_9(wxNewId()),
    menu_recent_document_10(wxNewId()),
    menu_recent_document_11(wxNewId()),
    menu_recent_document_12(wxNewId()),
    menu_recent_document_13(wxNewId()),
    menu_recent_document_14(wxNewId()),
    menu_recent_document_15(wxNewId()),
    menu_recent_document_16(wxNewId()),
    menu_recent_document_17(wxNewId()),
    menu_recent_document_18(wxNewId()),
    menu_recent_document_19(wxNewId()),
    menu_recent_document_20(wxNewId()),
    menu_recent_document_21(wxNewId()),
    menu_recent_document_22(wxNewId()),
    menu_recent_document_23(wxNewId()),
    menu_recent_document_24(wxNewId()),
    menu_recent_document_25(wxNewId()),
    menu_recent_document_26(wxNewId()),
    menu_recent_document_27(wxNewId()),
    menu_recent_document_28(wxNewId()),
    menu_recent_document_29(wxNewId()),
    menu_recent_document_separator(wxNewId()),
    menu_unsaved_document_0(wxNewId()),
    menu_unsaved_document_1(wxNewId()),
    menu_unsaved_document_2(wxNewId()),
    menu_unsaved_document_3(wxNewId()),
    menu_unsaved_document_4(wxNewId()),
    menu_unsaved_document_5(wxNewId()),
    menu_unsaved_document_6(wxNewId()),
    menu_unsaved_document_7(wxNewId()),
    menu_unsaved_document_8(wxNewId()),
    menu_unsaved_document_9(wxNewId()),
    menu_unsaved_document_10(wxNewId()),
    menu_unsaved_document_11(wxNewId()),
    menu_unsaved_document_12(wxNewId()),
    menu_unsaved_document_13(wxNewId()),
    menu_unsaved_document_14(wxNewId()),
    menu_unsaved_document_15(wxNewId()),
    menu_unsaved_document_16(wxNewId()),
    menu_unsaved_document_17(wxNewId()),
    menu_unsaved_document_18(wxNewId()),
    menu_unsaved_document_19(wxNewId()),
    menu_unsaved_document_20(wxNewId()),
    menu_unsaved_document_21(wxNewId()),
    menu_unsaved_document_22(wxNewId()),
    menu_unsaved_document_23(wxNewId()),
    menu_unsaved_document_24(wxNewId()),
    menu_unsaved_document_25(wxNewId()),
    menu_unsaved_document_26(wxNewId()),
    menu_unsaved_document_27(wxNewId()),
    menu_unsaved_document_28(wxNewId()),
    menu_unsaved_document_29(wxNewId()),
    menu_construct_fraction(wxNewId()),
    menu_insert_image(wxNewId()),
    menu_stats_mean(wxNewId()),
    menu_stats_median(wxNewId()),
    menu_stats_var(wxNewId()),
    menu_stats_dev(wxNewId()),
    menu_stats_tt1(wxNewId()),
    menu_stats_tt2(wxNewId()),
    menu_stats_tnorm(wxNewId()),
    menu_stats_linreg(wxNewId()),
    menu_stats_lsquares(wxNewId()),
    menu_stats_histogram(wxNewId()),
    menu_stats_scatterplot(wxNewId()),
    menu_stats_barsplot(wxNewId()),
    menu_stats_piechart(wxNewId()),
    menu_stats_boxplot(wxNewId()),
    menu_stats_readm(wxNewId()),
    menu_stats_enterm(wxNewId()),
    menu_stats_subsample(wxNewId()),
    menu_format_code(wxNewId()),
    menu_format_text(wxNewId()),
    menu_format_heading6(wxNewId()),
    menu_format_heading5(wxNewId()),
    menu_format_subsubsection(wxNewId()),
    menu_format_subsection(wxNewId()),
    menu_format_section(wxNewId()),
    menu_format_title(wxNewId()),
    menu_format_image(wxNewId()),
    menu_format_pagebreak(wxNewId()),
    menu_help_tutorials(wxNewId()),
    menu_help_tutorials_start(wxNewId()),
    menu_help_solving(wxNewId()),
    menu_help_diffequations(wxNewId()),
    menu_help_numberformats(wxNewId()),
    menu_help_tolerances(wxNewId()),
    menu_help_listaccess(wxNewId()),
    menu_help_memoizing(wxNewId()),
    menu_help_3d(wxNewId()),
    menu_help_varnames(wxNewId()),
    menu_help_fittingData(wxNewId()),
    menu_help_tutorials_end(wxNewId()),
    menu_show_toolbar(wxNewId()),
    menu_history_previous(wxNewId()),
    menu_history_next(wxNewId()),
    menu_check_updates(wxNewId()),
    gentran_load(wxNewId()),
    gentran_lang_c(wxNewId()),
    gentran_lang_fortran(wxNewId()),
    gentran_lang_ratfor(wxNewId()),
    gentran_to_stdout(wxNewId()),
    gentran_to_file(wxNewId()),
    socket_client_id(wxNewId()),
    socket_server_id(wxNewId()),
    gnuplot_query_terminals_id(wxNewId()),
    menu_additionalSymbols(wxNewId()),
    enable_unicodePane(wxNewId()),
    menu_showLatinGreekLookalikes(wxNewId()),
    menu_showGreekMu(wxNewId()),
    menu_invertWorksheetBackground(wxNewId())
  ...
  entries[15].Set(wxACCEL_CTRL, wxT('.'),
                  menu_interrupt_id); // Standard on the Mac
...
#define APPEND_MENU_ITEM(menu, id, label, help, stock)	\
  ...
  m_FileMenu->Append(menu_recent_documents, _("Open Recent"),
  ...
  m_FileMenu->Append(menu_recent_packages, _("Load Recent Package"),
  ...
  m_EditMenu->Append(menu_copy_text_from_worksheet,
                     _("Copy as Text\tCtrl+Shift+C"),
                     _("Copy selection from document as text"), wxITEM_NORMAL);
  m_EditMenu->Append(
		     menu_copy_matlab_from_worksheet, _("Copy for Octave/Matlab"),
  ...
  m_EditMenu->AppendSeparator();
  m_EditMenu->Append(
		     Worksheet::popid_comment_selection, _("Comment selection\tCtrl+/"),
  ...
  m_Maxima_Panes_Sub->AppendCheckItem(menu_show_toolbar,
                                      _("Main Toolbar\tAlt+Shift+B"));
  m_Maxima_Panes_Sub->AppendCheckItem(menu_pane_math,
                                      _("General Math\tAlt+Shift+M"));
  m_Maxima_Panes_Sub->AppendCheckItem(menu_pane_stats,
                                      _("Statistics\tAlt+Shift+S"));
  m_Maxima_Panes_Sub->AppendCheckItem(menu_pane_greek,
                                      _("Greek Letters\tAlt+Shift+G"));
  m_Maxima_Panes_Sub->AppendCheckItem(menu_pane_symbols,
                                      _("Symbols\tAlt+Shift+Y"));
  m_Maxima_Panes_Sub->AppendCheckItem(menu_pane_unicode,
                                      _("Unicode chars\tAlt+Shift+U"));
  m_Maxima_Panes_Sub->AppendCheckItem(menu_pane_history,
                                      _("History\tAlt+Shift+I"));
  m_Maxima_Panes_Sub->AppendCheckItem(menu_pane_structure,
                                      _("Table of Contents\tAlt+Shift+T"));
  m_Maxima_Panes_Sub->AppendCheckItem(menu_pane_format,
                                      _("Insert Cell\tAlt+Shift+C"));
  m_Maxima_Panes_Sub->AppendCheckItem(menu_pane_draw, _("Plot using Draw"));
  m_Maxima_Panes_Sub->AppendCheckItem(menu_pane_help,
  ...
  m_Maxima_Panes_Sub->AppendCheckItem(menu_pane_xmlInspector,
                                      _("Raw XML monitor"));
  ...
  m_Maxima_Panes_Sub->Append(menu_pane_hideall,
  ...
  m_equationTypeMenuMenu->AppendRadioItem(
					  menu_math_as_1D_ASCII, _("as 1D ASCII"),
					  _("Show equations in their linear form"));
  m_equationTypeMenuMenu->AppendRadioItem(menu_math_as_2D_ASCII,
                                          _("as ASCII Art"),
                                          _("2D equations using ASCII Art"));
  m_equationTypeMenuMenu->AppendRadioItem(menu_math_as_graphics, _("in 2D"),
  ...
  m_autoSubscriptMenu->AppendRadioItem(
				       menu_alwaysAutosubscript, _("Always after underscores"),
				       _("Always autosubscript after an underscore"));
  m_autoSubscriptMenu->AppendRadioItem(
				       menu_defaultAutosubscript, _("Only Integers and single letters"),
				       _("Autosubscript numbers and text following single letters"));
  m_autoSubscriptMenu->AppendRadioItem(
				       menu_noAutosubscript, _("Never"),
  ...
  m_Edit_Zoom_Sub->Append(menu_zoom_80, wxT("80%"), _("Set zoom to 80%"),
                          wxITEM_NORMAL);
  m_Edit_Zoom_Sub->Append(wxID_ZOOM_100, wxT("100%"), _("Set zoom to 100%"),
                          wxITEM_NORMAL);
  m_Edit_Zoom_Sub->Append(menu_zoom_120, wxT("120%"), _("Set zoom to 120%"),
                          wxITEM_NORMAL);
  m_Edit_Zoom_Sub->Append(menu_zoom_150, wxT("150%"), _("Set zoom to 150%"),
                          wxITEM_NORMAL);
  m_Edit_Zoom_Sub->Append(menu_zoom_200, wxT("200%"), _("Set zoom to 200%"),
                          wxITEM_NORMAL);
  m_Edit_Zoom_Sub->Append(menu_zoom_300, wxT("300%"), _("Set zoom to 300%"),
                          wxITEM_NORMAL);
...
#endif
  m_viewMenu->AppendSeparator();
  m_viewMenu->AppendCheckItem(menu_invertWorksheetBackground,
  ...
  {
    wxMenuItem *it =
      new wxMenuItem(m_CellMenu, menu_evaluate, _("Evaluate Cell(s)"),
  ...
  m_CellMenu->Append(
		     menu_evaluate_all_visible, _("Evaluate All Visible Cells\tCtrl+R"),
		     _("Evaluate all visible cells in the document"), wxITEM_NORMAL);
  {
    wxMenuItem *it = new wxMenuItem(
				    m_CellMenu, menu_evaluate_all, _("Evaluate All Cells\tCtrl+Shift+R"),
  ...
  m_CellMenu->Append(menu_insert_previous_input,
                     _("Copy Previous Input\tCtrl+I"),
                     _("Create a new cell with previous input"), wxITEM_NORMAL);
  m_CellMenu->Append(
		     menu_insert_previous_output, _("Copy Previous Output\tCtrl+U"),
  ...
  m_CellMenu->Append(menu_autocomplete_templates,
  ...
  insert_sub->Append(menu_add_subsubsection,
  ...
  m_CellMenu->Append(menu_insert_image, _("Insert Image..."), _("Insert image"),
                     wxITEM_NORMAL);
  m_CellMenu->AppendSeparator();
  ...
  m_CellMenu->AppendCheckItem(
			      Worksheet::popid_auto_answer, _("Automatically answer questions"),
  ...
  {
    wxMenuItem *it =
      new wxMenuItem(m_MaximaMenu, menu_interrupt_id, _("&Interrupt\tCtrl+G"),
  ...
  m_MaximaMenu->Append(
		       menu_display, _("Change &2d Display"),
  ...
  m_MaximaMenu->AppendSeparator();
  m_MaximaMenu->Append(
		       menu_jumptoerror, _("Jump to first error"),
  ...
  programMenu->Append(menu_block_noLocal,
  ...
  streamMenu->Append(menu_stringproc_openr, _("Open for reading..."));
  streamMenu->Append(menu_stringproc_opena, _("Open for appending..."));
  streamMenu->Append(menu_stringproc_openw, _("Open for writing..."));
  streamMenu->Append(menu_stringproc_setposition, _("Set position..."));
  streamMenu->Append(menu_stringproc_getposition, _("Get position..."));
  streamMenu->Append(menu_stringproc_flush_output, _("Flush..."));
  streamMenu->Append(menu_stringproc_flength, _("Length..."));
  streamMenu->Append(menu_stringproc_close, _("Close..."));
  stringMenu->Append(wxNewId(), _("Stream"), streamMenu);
  wxMenu *ioMenu = new wxMenu;
  ioMenu->Append(menu_stringproc_printf, _("printf..."));
  ioMenu->Append(menu_stringproc_readline, _("readline..."));
  ioMenu->Append(menu_stringproc_readchar, _("readchar..."));
  ioMenu->Append(menu_stringproc_readbyte, _("readbyte..."));
  ioMenu->Append(menu_stringproc_writebyte, _("writebyte..."));
  stringMenu->Append(wxNewId(), _("I/O"), ioMenu);
  wxMenu *charTestMenu = new wxMenu;
  charTestMenu->Append(menu_stringproc_charp, _("Is a char?..."));
  charTestMenu->Append(menu_stringproc_alphacharp, _("Is alphabetic?..."));
  charTestMenu->Append(menu_stringproc_alphanumericp, _("Is alphanumeric?..."));
  charTestMenu->Append(menu_stringproc_digitcharp, _("Is a digit?..."));
  charTestMenu->Append(menu_stringproc_constituent, _("Is printable?..."));
  charTestMenu->Append(menu_stringproc_uppercasep, _("Is uppercase?..."));
  charTestMenu->Append(menu_stringproc_lowercasep, _("Is lowercase?..."));
  charTestMenu->Append(menu_stringproc_cequal, _("Is equal?..."));
  charTestMenu->Append(menu_stringproc_cequalignore,
                       _("Equal, ignoring case?..."));
  charTestMenu->Append(menu_stringproc_clessp, _("Is lower?..."));
  charTestMenu->Append(menu_stringproc_clesspignore,
                       _("Lower, ignoring case?..."));
  charTestMenu->Append(menu_stringproc_cgreaterp, _("Is greater?..."));
  charTestMenu->Append(menu_stringproc_cgreaterpignore,
                       _("Greater, ignoring case?..."));
  stringMenu->Append(wxNewId(), _("Character Tests"), charTestMenu);
  wxMenu *stringtestMenu = new wxMenu;
  stringtestMenu->Append(menu_stringproc_sequal, _("Equal?..."));
  stringtestMenu->Append(menu_stringproc_sequalignore,
                         _("Equal, ignoring case?..."));
  stringMenu->Append(wxNewId(), _("String Tests"), stringtestMenu);
  wxMenu *convertMenu = new wxMenu;
  convertMenu->Append(menu_stringproc_create_ascii, _("Ascii code to char..."));
  convertMenu->Append(menu_stringproc_ascii, _("char to Ascii code..."));
  convertMenu->Append(menu_stringproc_cint, _("Char to Unicode code point..."));
  convertMenu->Append(menu_stringproc_unicode,
                      _("Unicode code point to char..."));
  convertMenu->Append(menu_stringproc_unicode_to_utf8,
                      _("Unicode code point to UTF8..."));
  convertMenu->Append(menu_stringproc_utf8_to_unicode,
                      _("UTF8 to Unicode code point..."));
  convertMenu->Append(menu_stringproc_charlist,
                      _("String to list of chars..."));
  convertMenu->Append(menu_stringproc_simplode,
                      _("List of chars to string..."));
  convertMenu->Append(menu_stringproc_eval_string, _("Evaluate string..."));
  convertMenu->Append(menu_stringproc_parse_string, _("Parse string only..."));
  convertMenu->Append(menu_stringproc_number_to_octets,
                      _("Number to octets..."));
  convertMenu->Append(menu_stringproc_octets_to_number,
                      _("Octets to number..."));
  convertMenu->Append(menu_stringproc_octets_to_string,
                      _("Octets to string..."));
  convertMenu->Append(menu_stringproc_string_to_octets,
                      _("String to octets..."));
  stringMenu->Append(wxNewId(), _("Conversions"), convertMenu);
  wxMenu *transformMenu = new wxMenu;
  transformMenu->Append(menu_stringproc_charat, _("Extract char..."));
  transformMenu->Append(menu_stringproc_sinsert, _("Insert char..."));
  transformMenu->Append(menu_stringproc_scopy, _("Copy string..."));
  transformMenu->Append(menu_stringproc_sdowncase, _("Convert to downcase..."));
  transformMenu->Append(menu_stringproc_slength, _("Length..."));
  transformMenu->Append(menu_stringproc_smake, _("Create empty string..."));
  transformMenu->Append(menu_stringproc_smismatch,
                        _("Find first difference..."));
  transformMenu->Append(menu_stringproc_split, _("Split..."));
  transformMenu->Append(menu_stringproc_sposition, _("Find char in string..."));
  transformMenu->Append(menu_stringproc_sremove,
                        _("Remove all occurrences of a word..."));
  transformMenu->Append(menu_stringproc_sremovefirst,
                        _("Remove first occurrence of a word..."));
  transformMenu->Append(menu_stringproc_tokens, _("Tokenize..."));
  transformMenu->Append(menu_stringproc_ssearch, _("Search..."));
  transformMenu->Append(menu_stringproc_ssort, _("Sort the characters..."));
  transformMenu->Append(menu_stringproc_ssubstfirst, _("Replace..."));
  transformMenu->Append(menu_stringproc_strim, _("Trim both ends..."));
  ...
  dirMenu->Append(menu_opsyst_directory, _("List directory..."));
  dirMenu->Append(menu_opsyst_pathname_directory,
                  _("Extract dir from path..."));
  dirMenu->Append(menu_opsyst_pathname_name,
                  _("Extract filename from path..."));
  dirMenu->Append(menu_opsyst_pathname_type,
  ...
  m_gentranMenu->AppendRadioItem(gentran_lang_ratfor,
  ...
  solve_sub->Append(menu_solve, _("&Solve..."), _("Solve equation(s)"),
                    wxITEM_NORMAL);
  ...
  m_EquationsMenu->Append(
			  menu_lhs, _("Left side to the \"=\""),
			  _("The half of the equation that is to the left of the \"=\""),
			  wxITEM_NORMAL);
  m_EquationsMenu->Append(
			  menu_rhs, _("Right side to the \"=\""),
  ...
  gen_matrix_menu->Append(
			  menu_gen_mat_lambda, _("Generate Matrix from Expression..."),
  ...
  matrix_classicOP_menu->Append(
				menu_rank, _("Rank"), _("Compute the rank of a matrix"), wxITEM_NORMAL);
  ...
  lapack_menu->Append(menu_matrix_loadLapack, _("Load lapack"),
                      _("Load lapack"), wxITEM_NORMAL);
  lapack_menu->Append(menu_matrix_dgeev_eigenvaluesOnly,
                      _("Eigenvalues (real)"),
                      _("Compile eigenvalues using dgeev"), wxITEM_NORMAL);
  lapack_menu->Append(menu_matrix_zgeev_eigenvaluesOnly,
                      _("Eigenvalues (complex)"),
                      _("Compile eigenvalues using zgeev"), wxITEM_NORMAL);
  lapack_menu->Append(
		      menu_matrix_dgeev, _("Eigenvalues, left+right eigenvectors (real)"),
		      _("Compile eigenvalues+eigenvectors using dgeev"), wxITEM_NORMAL);
  lapack_menu->Append(menu_matrix_zgeev,
  ...
  lapack_menu->Append(menu_matrix_dgesvd,
  ...
  lapack_menu->Append(menu_matrix_dlange_frobenius,
                      _("Frobenius Norm sqrt(sum((A(i,j))^2)) (real)"));
  lapack_menu->Append(menu_matrix_zlange_frobenius,
  ...
  matrix_rowOp_sub->Append(
			   menu_matrix_row_list, _("Convert Row to list..."),
			   _("Extract a row from the matrix and convert it to a list"),
			   wxITEM_NORMAL);
  matrix_rowOp_sub->Append(
			   menu_matrix_col_list, _("Convert Column to list..."),
  ...
  m_matrix_menu->AppendSeparator();
  m_matrix_menu->Append(menu_map_mat,
                        _("A&pply function to each Matrix element..."),
                        _("Map function to a matrix"), wxITEM_NORMAL);
  m_matrix_menu->Append(
			menu_map, _("Dito, but affect all clones of the Matrix..."),
  ...
  m_CalculusMenu->Append(
			 menu_change_var_evaluate, _("Dito, and evaluate the result..."),
  ...
  m_CalculusMenu->Append(menu_sum, _("Calculate Su&m..."), _("Calculate sums"),
                         wxITEM_NORMAL);
  ...
  m_CalculusMenu->Append(menu_laplace, _("Laplace &Transform..."),
                         ...
                         wxITEM_NORMAL);
  m_CalculusMenu->Append(
			 menu_ilt, _("Inverse Laplace T&ransform..."),
  ...
  simplify_sub->Append(menu_scanmapfactor,
  ...
  m_logexpand_Sub->Append(
			  menu_logcontract, _("Contract Logarithms"),
			  _("Convert sum of logarithms to logarithm of product"), wxITEM_NORMAL);
  m_logexpand_Sub->Append(menu_logexpand,
  ...
  m_logexpand_Sub->AppendRadioItem(
				   menu_logexpand_all, _("Additionally: log(a*b)=log(a)+log(b)"),
  ...
  m_Simplify_Complex_Sub->Append(
				 menu_imagpart, _("Get &Imaginary Part"),
  ...
  m_Simplify_Complex_Sub->Append(menu_demoivre, _("&Demoivre"),
                                 ...
                                 wxITEM_NORMAL);
  m_Simplify_Complex_Sub->Append(
				 menu_exponentialize, _("&Exponentialize"),
  ...
  m_subst_Sub->Append(menu_subst, _("Substitute only in parts..."),
                      ...
                      wxITEM_NORMAL);
  m_subst_Sub->AppendCheckItem(menu_opsubst,
  ...
  listcreateSub->Append(
			menu_list_create_from_elements, _("from individual elements"),
  ...
  listcreateSub->Append(menu_list_actual_values_storage,
                        ...
                        wxITEM_NORMAL);
  listcreateSub->Append(
			menu_list_create_from_args, _("from function arguments"),
  ...
  listuseSub->Append(
		     menu_map_lambda, _("Run each element through an expression"),
		     _("Runs each element through an expression"), wxITEM_NORMAL);
  listuseSub->Append(
		     menu_list_use_actual_values, _("use the actual values stored"),
		     _("Introduce the actual values for variables stored in the list"),
		     wxITEM_NORMAL);
  listuseSub->Append(
		     menu_list_as_function_arguments, _("use as function arguments"),
  ...
  listextractmenu->Append(menu_list_nth, _("nth"),
                          _("Returns an arbitrary list item"));
  listextractmenu->Append(menu_list_first, _("First"),
                          _("Returns the first item of the list"));
  listextractmenu->Append(menu_list_rest, _("All but the 1st n elements"),
  ...
  listextractmenu->Append(menu_list_last, _("Last"),
                          _("Returns the last item of the list"));
  listextractmenu->Append(menu_list_lastn, _("Last n"),
                          _("Returns the last n items of the list"));
  listextractmenu->Append(
			  menu_list_extract_value, _("Extract an actual value for a variable"),
  ...
  listappendSub->Append(
			menu_list_append_item_start, _("Prepend an element"),
  ...
  m_PlotMenu->Append(gp_plot2, _("Plot &2d..."), _("Plot in 2 dimensions"),
                     wxITEM_NORMAL);
  m_PlotMenu->Append(gp_plot3, _("Plot &3d..."), _("Plot in 3 dimensions"),
                     wxITEM_NORMAL);
  ...
  m_NumericMenu->AppendCheckItem(
				 menu_num_domain, _("Expect numbers harder to be complex"),
  ...
  m_NumericMenu->Append(
			menu_set_precision, _("Set bigfloat &Precision..."),
			...
			wxITEM_NORMAL);
  m_NumericMenu->Append(
			menu_set_displayprecision, _("Set &displayed Precision..."),
			_("Shows how many digits of a numbers are displayed"), wxITEM_NORMAL);
  m_NumericMenu->AppendSeparator();
  m_NumericMenu->AppendCheckItem(
				 menu_engineeringFormat, _("Engineering format (12.1e6 etc.)"),
				 _("Print floating-point numbers with exponents dividable by 3"));
  m_NumericMenu->Append(
			menu_engineeringFormatSetup, _("Setup the engineering format..."),
  ...
  m_HelpMenu->AppendRadioItem(menu_maxima_uses_internal_help,
  ...
  if (m_configuration.OfferInternalHelpBrowser())
    m_HelpMenu->AppendRadioItem(menu_maxima_uses_wxmaxima_help,
                                _("Maxima shows help in a sidebar"),
                                _("Tells maxima to show the help for ?, ?? and "
                                  "describe() in a wxMaxima sidebar"));
  m_HelpMenu->AppendRadioItem(menu_maxima_uses_html_help,
  ...
  tutorials_sub->Append(menu_help_listaccess, _("Fast list access"), "",
                        wxITEM_NORMAL);
  tutorials_sub->Append(menu_help_memoizing, _("Memoizing"), "", wxITEM_NORMAL);
  ...
  m_HelpMenu->Append(menu_bug_report, _("&Bug Report"), _("Report bug"),
                     wxITEM_NORMAL);
...
void wxMaximaFrame::UpdateRecentDocuments() {
  ...
  for (int i = menu_recent_document_0;
       i <= menu_recent_document_0 + recentItems; i++) {
  ...
  for (int i = menu_unsaved_document_0;
       i <= menu_unsaved_document_0 + recentItems; i++) {
  ...
  for (int i = menu_recent_package_0; i <= menu_recent_package_0 + recentItems;
       i++) {
...
wxWindow *wxMaximaFrame::CreateMathPane() {
  ...
  grid->Add(new wxButton(panel, button_radcan, _("Simplify (r)"),
                         wxDefaultPosition, wxDefaultSize),
            0, style, border);
  grid->Add(new wxButton(panel, button_factor, _("Factor"), wxDefaultPosition,
                         wxDefaultSize),
            0, style, border);
  grid->Add(new wxButton(panel, button_expand, _("Expand"), wxDefaultPosition,
                         wxDefaultSize),
            0, style, border);
  grid->Add(new wxButton(panel, button_rectform, _("Rectform"),
                         wxDefaultPosition, wxDefaultSize),
            0, style, border);
  grid->Add(new wxButton(panel, button_subst, _("Subst..."), wxDefaultPosition,
                         wxDefaultSize),
            0, style, border);
  ...
  grid->Add(new wxButton(panel, button_trigreduce, _("Reduce (tr)"),
                         wxDefaultPosition, wxDefaultSize),
            0, style, border);
  grid->Add(new wxButton(panel, button_solve, _("Solve..."), wxDefaultPosition,
                         wxDefaultSize),
            0, style, border);
  grid->Add(new wxButton(panel, button_solve_ode, _("Solve ODE..."),
                         wxDefaultPosition, wxDefaultSize),
            0, style, border);
  grid->Add(new wxButton(panel, button_diff, _("Diff..."), wxDefaultPosition,
                         wxDefaultSize),
            0, style, border);
  grid->Add(new wxButton(panel, button_integrate, _("Integrate..."),
                         wxDefaultPosition, wxDefaultSize),
            0, style, border);
  grid->Add(new wxButton(panel, button_limit, _("Limit..."), wxDefaultPosition,
                         wxDefaultSize),
            0, style, border);
...
void wxMaximaFrame::GreekPane::OnMouseRightDown(wxMouseEvent &WXUNUSED(event)) {
  ...
  popupMenu->AppendCheckItem(menu_showLatinGreekLookalikes,
                             _(wxT("Show greek \u21D4 latin lookalikes")));
  popupMenu->Check(menu_showLatinGreekLookalikes,
                   m_configuration->GreekSidebar_ShowLatinLookalikes());
  popupMenu->AppendCheckItem(menu_showGreekMu,
...
wxWindow *wxMaximaFrame::CreateFormatPane() {
  ...
  grid->Add(new wxButton(panel, menu_format_text, _("Text"), wxDefaultPosition,
                         wxDefaultSize),
            0, style, border);
...
wxMaximaFrame::DrawPane::DrawPane(wxWindow *parent, int id)
  ...
  m_grid->Add(m_draw_explicit =
	      new wxButton(this, menu_draw_explicit, _("Expression"),
			   wxDefaultPosition, wxDefaultSize),
              0, style, border);
  m_draw_explicit->SetToolTip(
			      _("The standard plot command: Plot an equation as a curve"));
  m_grid->Add(m_draw_implicit =
	      new wxButton(this, menu_draw_implicit, _("Implicit Plot"),
			   wxDefaultPosition, wxDefaultSize),
              0, style, border);
  m_grid->Add(m_draw_parametric =
	      new wxButton(this, menu_draw_parametric, _("Parametric Plot"),
			   wxDefaultPosition, wxDefaultSize),
              0, style, border);
  ...
  m_grid->Add(m_draw_title =
	      new wxButton(this, menu_draw_title, _("Diagram title"),
			   wxDefaultPosition, wxDefaultSize),
              0, style, border);
  m_draw_title->SetToolTip(_("The diagram title"));
  m_grid->Add(m_draw_axis = new wxButton(this, menu_draw_axis, _("Axis"),
                                         wxDefaultPosition, wxDefaultSize),
              0, style, border);
  m_draw_axis->SetToolTip(_("Setup the axis"));
  m_grid->Add(m_draw_contour =
	      new wxButton(this, menu_draw_contour, _("Contour"),
			   wxDefaultPosition, wxDefaultSize),
              0, style, border);
  ...
  m_grid->Add(m_draw_fgcolor =
	      new wxButton(this, menu_draw_fgcolor, _("Line color"),
			   wxDefaultPosition, wxDefaultSize),
              0, style, border);
  m_draw_fgcolor->SetToolTip(_("The color of the next line to draw"));
  m_grid->Add(m_draw_fillcolor =
	      new wxButton(this, menu_draw_fillcolor, _("Fill color"),
			   wxDefaultPosition, wxDefaultSize),
              0, style, border);
  m_draw_fillcolor->SetToolTip(_("The fill color for the next objects"));
  m_grid->Add(m_draw_grid = new wxButton(this, menu_draw_grid, _("Grid"),
                                         wxDefaultPosition, wxDefaultSize),
              0, style, border);
  ...
  m_grid->Add(m_draw_accuracy =
	      new wxButton(this, menu_draw_accuracy, _("Accuracy"),
			   wxDefaultPosition, wxDefaultSize),
              0, style, border);
