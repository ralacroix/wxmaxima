...
public:
  ...
  */
  enum PopIds
  {
    ...
    popid_property_constant,
    popid_property_even,
    popid_property_odd,
    popid_property_evenfun,
    popid_property_oddfun,
    popid_property_increasing,
    popid_property_decreasing,
    popid_property_integer,
    popid_property_noninteger,
    popid_property_integervalued,
    popid_property_lassociative,
    popid_property_rassociative,
    popid_property_linear,
    popid_property_mainvar,
    popid_property_multiplicative,
    popid_property_nary,
    popid_property_nonarray,
    popid_property_nonscalar,
    popid_property_scalar,
    popid_property_noun,
    popid_property_outative,
    popid_property_posfun,
